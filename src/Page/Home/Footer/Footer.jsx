      ...
      <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
        ...
        <div className="flex flex-col items-center">
          <a href="#" className="mb-8 inline-block max-w-full text-black">
            <img src="https://assets.website-files.com/6458c625291a94a195e6cf3a/6458c625291a94d6f4e6cf96_Group%2047874-3.png" alt="" className="inline-block max-h-10" />
          </a>
          ...
          <div className="mb-8 mt-8 w-48 border-b border-solid border-black"></div>
          <div className="mb-12 grid w-full max-w-[208px] grid-flow-col grid-cols-4 gap-3">
            <SocialLink href="#" iconSrc="https://assets.website-files.com/6357722e2a5f19121d37f84d/6358f65ff1579cbd64244573_FacebookLogo.svg" />
            <SocialLink href="#" iconSrc="https://assets.website-files.com/6357722e2a5f19121d37f84d/6358f65864ee6f4870bbe5cb_InstagramLogo.svg" />
            <SocialLink href="#" iconSrc="https://assets.website-files.com/6357722e2a5f19121d37f84d/6358f65ab9fdec6c06b596f6_SlackLogo.svg" />
            <SocialLink href="#" iconSrc="https://assets.website-files.com/6357722e2a5f19121d37f84d/6358f65b64ee6f2f15bbe5e0_TwitterLogo.svg" />
          </div>
...
const SocialLink = ({ href, iconSrc }) => {
  return (
    <a href={href} className="mx-auto flex max-w-[24px] flex-col items-center justify-center">
